/**
 * @fileoverview Login page component. Allows users to log in using Google or Twitch OAuth.
 * This page uses the AuthContext for handling sign-in and redirects users
...
export default function LoginPage() {
  ...
  const handleTwitchSignIn = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Failed to log in with Twitch."
      setError(errorMessage)
    } finally {
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/40 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">Log in using Google or Twitch</CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
          ...
          >
            ...
            {isLoadingTwitch ? "Logging in..." : "Log in with Twitch"}
          </Button>
